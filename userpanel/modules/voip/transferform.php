 ...
 *  USA.
 *
 *  $Id: transferform.php,v 1.6.2.1 2006/01/16 09:49:58 lexx Exp $
 */

global $LMS,$CONFIG,$SESSION,$voip;
$customer = $LMS->GetCustomer($SESSION->id);
$voip->GetCustomer(&$customer,$SESSION->id);
//var_dump($customer);exit;
$customer['balance']=$customer['voipbalance'];
...
$ISP1_DO = (! $CONFIG['finances']['line_1'] ? 'LINIA1xxxxxxxxxxxxxxxxxxxyz' : iconv('UTF-8','ISO-8859-2',$CONFIG['finances']['line_1']));
$ISP2_DO = (! $CONFIG['finances']['line_2'] ? 'linia2xxxxxxxxxxxxxxxxxxxyz' : iconv('UTF-8','ISO-8859-2',$CONFIG['finances']['line_2']));
$USER_T1 = (! $CONFIG['finances']['pay_title'] ? 'Abonament - ID:%CID% %LongCID%' : iconv('UTF-8','ISO-8859-2',$CONFIG['finances']['pay_title']));
$CURR = 'PLN';
$SHORT_TO_WORDS = $CONFIG['phpui']['to_words_short_format'];
