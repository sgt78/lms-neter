 ...
 *  USA.
 *
 *  $Id: invoice_pdf16.php,v 1.2.2.1 2006/01/16 09:49:58 lexx Exp $
 */
...
function invoice_body() 
{
	...
	case "FT-0100":
	    ...
	    break;
	default:
	    if(file_exists($CONFIG['invoices']['template_file']))
		    require($CONFIG['invoices']['template_file']);
	    else //go to LMS modules directory
		    require($_SYSTEM_DIR.'/modules/'.$CONFIG['invoices']['template_file']);
    }
