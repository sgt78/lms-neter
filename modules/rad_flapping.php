 ...
 *  USA.
 *
 *  $Id: nodelist.php,v 1.45.2.2 2008/01/04 07:58:14 alec Exp $
 */

$layout['pagetitle'] = 'Lista użytkowników, którym często rozłącza sesję';
...
$nodelist = $RADIUS->GetFlappingLoginsList($hours);
...
$SMARTY->display('rad_flapping.html');
