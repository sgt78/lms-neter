...
if($tab && $_POST['wykr']==1)
$calosc[$voip->toutf8($username)]['wykres']=open_flash_chart_object( 1005, 700, 'http://'. $_SERVER['SERVER_NAME'] .'/chart-data.php?g='.$g, false );
}
else
if($tab && $_POST['wykr']==1)
$calosc[$voip->toutf8($username)]['wykres']=open_flash_chart_object( 1005, 700, 'http://'. $_SERVER['SERVER_NAME'] .'/chart-data2.php?g='.$g, false );
}
 fclose($fp);
