 ...
 *  USA.
 *
 *  $Id: info.php,v 1.6.2.2 2008/01/04 07:57:37 alec Exp $
 */

$engine = array(
	'name' 			=> 'umowa_zlecenie', 	// template directory
	'engine' 		=> 'umowa_zlecenie', 	// engine.php directory
											// you can use other engine
	'template' 		=> 'template.html', 	// template file (in 'name' dir)
	'title' 		=> trans('Umowa zlecenie'), 	// description for UI
	'content_type' 	=> 'text/html', 		// output file type
	'output' 		=> 'uz.html', 			// output file name
