 ...
 *  USA.
 *
 *  $Id: info.php,v 1.5 2006/09/06 16:58:52 alec Exp $
 */



$engine = array(
	'name' => 'wezwanie-2', 			// template directory
	'engine' => 'wezwanie-2', 		// engine.php directory
						// you can use other engine
	'template' => 'template.html', 		// template file (in 'name' dir)
	'title' => "Wezwanie do zapłaty z odsetkami",			// description for UI
	'content_type' => 'text/html', 		// output file type
	'output' => 'wezwanie.html', 		// output file name
