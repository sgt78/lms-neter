 ...
 *  USA.
 *
 *  $Id: info.php,v 1.1.2.2 2006/01/16 09:35:23 alec Exp $
 */

$engine = array(
	'name' 				=> 'radionet_protokol', 	// template directory
	'engine' 			=> 'radionet_protokol', 	// engine.php directory
												// you can use other engine
	'template' 			=> 'template.html', 		// template file (in 'name' dir)
	'title' 			=> trans('RadioNet Protokół techniczny'), 	// description for UI
