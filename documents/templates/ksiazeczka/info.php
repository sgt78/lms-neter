...
$engine = array(
	'name' => 'ksiazeczka', 	// template directory
	'engine' => 'ksiazeczka', 	// engine.php directory
				// you can use other engine
	'template' => 'template.html', 		// template file (in 'name' dir)
	'title' => 'Ksiazeczka oplat', // description for UI
	'content_type' => 'text/html', 		// output file type
	'output' => 'ksiazeczka.html', 		// output file name
